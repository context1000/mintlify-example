...
related:
  ...
  adrs: [002-react-spa-architecture, 003-feature-based-architecture]
  rules: [002-react-component-rules, 003-code-organization-rules]
  guides: [002-component-development-guide, 003-feature-development-guide]
---
